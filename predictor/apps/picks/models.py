...
class Pick(models.Model):
    fixture = models.ForeignKey(Fixture, related_name='users_who_picked', on_delete=models.CASCADE)
    user = models.ForeignKey(User, related_name='picks', on_delete=models.CASCADE)
