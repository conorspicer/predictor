    ...
    FROM
        (SELECT
            `predictions`.`pick_id` AS `pick_id`,
                ...
                `predictions`.`fixture_id` AS `fixture_id`,
                ...
                `predictions`.`away_team_logo` AS `away_team_logo`,
                `predictions`.`home_team_name` AS `home_team_name`,
                `predictions`.`home_team_logo` AS `home_team_logo`,
        ...
        FROM
            ...
            `raw_picks`.`pick_id` AS `pick_id`,
                ...
                `raw_picks`.`fixture_id` AS `fixture_id`,
                ...
                `raw_picks`.`username` AS `username`,
                `raw_picks`.`away_team_name` AS `away_team_name`,
                `raw_picks`.`away_team_logo` AS `away_team_logo`,
                `raw_picks`.`home_team_name` AS `home_team_name`,
                `raw_picks`.`home_team_logo` AS `home_team_logo`,
